...
#import "CAAnimation+MHRefresh.h"
@interface MHRefreshHeader ()
/// logo
...
- (void)setState:(MJRefreshState)state{
    ...
    switch (state) {
        ...
        case MJRefreshStateRefreshing:
            [self.loadingView.layer addAnimation:[CAAnimation mh_rotationAnimation] forKey:@"MH_rotationAnimation"];
            break;
        default:
            break;
    }
...
- (void)setPullingPercent:(CGFloat)pullingPercent{
    ...
    [self.loadingView.layer addAnimation:[CAAnimation mh_rotaAnimStartAngle:self.preAngle endAngle:pullingPercent] forKey:@"rotaAnims"];
