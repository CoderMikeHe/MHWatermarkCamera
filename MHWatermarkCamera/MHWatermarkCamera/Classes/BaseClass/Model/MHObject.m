...
// occurred.
static BOOL MHValidateAndSetValue(id obj, NSString *key, id value, BOOL forceUpdate, NSError **error) {
...
- (BOOL)validate:(NSError **)error {
    for (NSString *key in self.class.propertyKeys) {
        ...
        BOOL success = MHValidateAndSetValue(self, key, value, NO, error);
