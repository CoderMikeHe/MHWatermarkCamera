...
// MHCollectionViewController 跟 MHTableViewViewController 使用类似

#import "MHViewController.h"

@interface MHCollectionViewController : MHViewController<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
