...
FOUNDATION_EXTERN NSString *const MHViewControllerIDKey;
/// 传递数据模型的key：例如 商品模型的传递 用户模型的传递...
FOUNDATION_EXTERN NSString *const MHViewControllerUtilKey;
/// 传递webView Request Url的key：例如 webView request...
FOUNDATION_EXTERN NSString *const MHViewControllerRequestUrlKey;
...
/// ------------ Property ------------
/// The `params` parameter in `-initWithParams:` method.
/// The `params` Key's `MHViewControllerIDKey`
